...
function display_school_details_form()								// display html change details form
{
...
//	$query2 = "select * from uctmathcomp_school_info";
//	echo $query2;
//	$result2 = mysql_query($query2);
//	if (!$result2)
//		return false;
//	echo "progress";
//	$uctmathcomp_school_info = mysql_fetch_row($result2);
	
	
//	while (!($uctmathcomp_school_info[1] == $Key))
//	{
//		$uctmathcomp_school_info = mysql_fetch_row($result2);
//	}
//	$Temp = 1
//	while ($Temp = 1) //($uctmathcomp_school_info[1] == $Key)
//	{
//			$uctmathcomp_school_info = mysql_fetch_row($result2);
//			$Temp++;
//	}	
?>
	...
	<table>   
		...
		<tr>
			...
			<td>
				<textarea name="postadd" rows=3 cols=30><? echo $row[8]; ?> </textarea>
			</td>
		</tr>				
		<tr>
			<td>
